...
//? This entire DOM tree is then accessible to Javascript as an object. Javascript can interact with this ibject to manipulate the content, structure, and style of the document dynamically. The DOM essentially serves as an interface between the HTML document and JavaScript, providing a way for scrpting to access and modify the document's structure and content.
...
//? getElementsByTagName(tagName): Find element with a specific tag name.
...
//? addEventListerner(event, function): Create an event listener to handle events.

//? removeEventListerner(event, function): Remove an event listener.
