...
//? A promise in Javascript is an object that represents the eventual completion or failure of an asynchronous operation. It allows you to handle asynchronous operations more easily and cleanly by providing a way to write asynchronous code that look synchronous.
...
//? Promises have built-in methods like then and catch to handle the results of asynchronous operations when they complete or encounter errors, making it easier to write asynchronous code thath is more readable and maintainable compared to traditional callback-based approaches.
...
// todo 2: Promise Mode: Your friend promises to call after 2 days at 6 pm. This is similar to creating a promise in Javascript.

// todo 3: Pending Stage: During the 2-day period, you're in a "pending" stage, You're not sure whether your friend will fulfill the promise (call you) or break the promise (not call you). Similarly, when you create a promise in Javascript, it starts in a pending state until it either resolve (fulfills) or rejects.
...
//     // Id there's an error, call reject(error)
//   });
// }

// const pr = new Promise((resolve, reject) => {
//   //   setTimeout(() => {
//   //     resolve("Hello, I miss U");
//   //   }, 2000);
//   setTimeout(() => {
...
//? Promise.allSettled is used when you wnat to wait all promises to complete, regardless of success or failure, and get information about thir outcomes.

//? Promise.race is used when you are interested in the first promise that completes, regardless of success or failure.
...
// The catch method is used to handle the failure case, printing a error message.
